...
const studyPlans_route_1 = __importDefault(require("./routes/studyPlans.route"));
const aiPlan_route_1 = __importDefault(require("./routes/aiPlan.route"));
...
app_1.default.use('/api', studyPlans_route_1.default);
app_1.default.use('/api/ai', aiPlan_route_1.default);
